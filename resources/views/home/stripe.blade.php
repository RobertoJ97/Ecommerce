            ...
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('images/visa.jpg') }}" width="200px" height="40px">
                        </div>
                    </div>
                    ...
                    <form
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-6 form-group required'>
                                <label class='control-label'>Costumer Name</label> <input
                                    class='form-control' name="name" size='4' type='text'>
                            </div>
                            <div class='col-xs-6 form-group required'>
                                <label class='control-label'>Email Address</label> <input
                                    class='form-control' name="rec_address" size='4' type='text'>
                            </div>
                        </div>
                        <div class='form-row row'>
                            <div class='col-xs-6 form-group required'>
                            ...
                            <div class='col-xs-6 form-group required'>
                                <label class='control-label'>Phone Number</label> <input
                                    class='form-control' name="phone" size='4' type='text'>
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Name Card</label> <input
